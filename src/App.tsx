...
function App(): JSX.Element {
  const { session, loading, demoMode } = useSupabaseAuth();
    ...
    <div className="app-shell">
      <div className="header">
        ...
        <div className="stack-row">
          ...
          {demoMode && <span className="badge warning">Demo-läge (ingen Supabase-konfig)</span>}
          {!demoMode && (
      ...
      <section className="intro">
        <div>
          <h2>Projektportfölj-verktyg (MVP)</h2>
          <p className="muted">
            Målet är en webapp som låter dig registrera projekt, aktiviteter, beslutspunkter och enkla beroenden
            inom samma projekt – med portföljvy, Supabase Auth och auto-deploy via Netlify/GitHub Pages.
          </p>
        </div>
        <div className="intro-grid">
          <div className="info-card">
            <h3>Syfte</h3>
            <ul>
              <li>Registrera projekt med start/slut och roller.</li>
              <li>Skapa aktiviteter och beslutspunkter.</li>
              <li>Hantera beroenden mellan aktiviteter (finish-to-start i MVP).</li>
              <li>Ge en enkel portföljvy med filter.</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>Arkitektur</h3>
            <ul>
              ...
              <li>Backend/data: Supabase (PostgreSQL + Auth) – eller demo-läge utan backend.</li>
              <li>Hosting: GitHub Pages eller Netlify med automatisk build på push.</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>Datamodell</h3>
            <ul>
              <li>users: id, email, name, role.</li>
              <li>projects: namn, datum, roller, status, prioritet.</li>
              <li>activities: tillhör projekt, ansvarig, status och datum.</li>
              <li>milestones: beslutstyper och datum.</li>
              <li>dependencies: from_activity → to_activity.</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>Tidsuppskattning</h3>
            <p className="muted small">MVP 1: ca 60–120 timmar beroende på UI-nivå.</p>
            <ul className="muted small">
              <li>Setup stack: 8–15 h</li>
              <li>Datamodell: 4–8 h</li>
              <li>Auth + skydd: 8–15 h</li>
              <li>Projekt-CRUD: 10–15 h</li>
              <li>Aktiviteter & beslut: 10–20 h</li>
              <li>Portföljvy: 8–15 h</li>
              <li>Deploy & småfix: 8–15 h</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>Funktioner i MVP</h3>
            <ul>
              <li>Inloggning via Supabase Auth.</li>
              <li>Projektlista med statusfilter.</li>
              <li>Projektdetaljer med aktiviteter, beslutspunkter och beroenden.</li>
              <li>Formulär för CRUD på alla delar.</li>
              <li>Deployment via Netlify eller GitHub Pages.</li>
            </ul>
          </div>
          <div className="info-card">
            <h3>Namnidéer (.se)</h3>
            <p className="muted small">portfoljkollen.se · portfoljpanelen.se · projektflode.se · projektkompassen.se · projektkedjan.se · projfolio.se · flowfolio.se · impactflow.se</p>
          </div>
        </div>
      </section>
